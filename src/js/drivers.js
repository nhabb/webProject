document.addEventListener("DOMContentLoaded", () => {
    ...
    const players = [
        { rank: 1, name: "Max ", lastName: "Verstappen", points: 437, team: "red-bull-racing-logo.png", image: "max.png", country: "NL.png" },
        ...
        { rank: 4, name: "Oscar ", lastName: "Piastri", points: 292, team: "mc-logo.png", image: "piastry.png", country: "au.png" },
        { rank: 5, name: "Carlos ", lastName: "Sainz", points: 290, team: "fer-logo.png", image: "carlos.png", country: "es.png" },
        { rank: 6, name: "George ", lastName: "Russell", points: 245, team: "mer-logo.png", image: "russel.png", country: "uk.png" },
        ...
        { rank: 12, name: "Yuki ", lastName: "Tsunoda", points: 30, team: "rbb-logo.png", image: "yuki.png", country: "jp.png" },
        { rank: 13, name: "Lance ", lastName: "Stroll", points: 24, team: "am-logo.png", image: "stroll.png", country: "Cn.png" },
        { rank: 14, name: "Esteban ", lastName: "Ocon", points: 23, team: "alp-logo.png", image: "doohan.png", country: "fr.png" },
        { rank: 15, name: "Kevin ", lastName: "Magnussen", points: 16, team: "haas-logo.png", image: "magnusen.png", country: "dk.png" },
        { rank: 16, name: "Alexander ", lastName: "Albon", points: 12, team: "wil-logo.png", image: "albon.png", country: "th.png" },
        { rank: 17, name: "Daniel ", lastName: "Ricciardo", points: 12, team: "rbb-logo.png", image: "riccardo.png", country: "au.png" },
        ...
        { rank: 23, name: "Logan ", lastName: "Sargeant", points: 0, team: "wil-logo.png", image: "seargant.png", country: "us.png" },
